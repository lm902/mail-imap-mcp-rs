...
- Do not change package scope (`@lm902`) unless explicitly requested.
...
- Keep Linux x64 release targets aligned with dist config. Current native targets are `x86_64-unknown-linux-gnu` and `x86_64-unknown-linux-musl`.
